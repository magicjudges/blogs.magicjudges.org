...
class CETS_social_media_links_widget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <div class="cets-social-wrap">
            ...
            <div class="cets-social-admin-section-wrap">
                ...
                <p>The title is displayed at the top of your widget. You might want to use something like "Find Us On",
                    "Join Us On", or "Connect with Us"</p>
            ...
            <div class="cets-social-admin-note-wrap">
                <p>Be sure to include FULL URLs that start with http:// and link to YOUR actual social media page. It's
                    always a good idea to test links after you add them!</p>
            </div>

            <!-- facebook -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('facebook'); ?>"
                                name="<?php echo $this->get_field_name('facebook'); ?>" type="text"
                                value="<?php echo $facebook; ?>"/></label></p>
            </div>


            <!-- twitter -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('twitter'); ?>"
                                name="<?php echo $this->get_field_name('twitter'); ?>" type="text"
                                value="<?php echo $twitter; ?>"/></label></p>
            </div>

            <!-- googleplus -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('googleplus'); ?>"><?php _e('Google+:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('googleplus'); ?>"
                                name="<?php echo $this->get_field_name('googleplus'); ?>" type="text"
                                value="<?php echo $googleplus; ?>"/></label></p>
            </div>

            <!-- Pinterest -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('pinterest'); ?>"><?php _e('Pinterest:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('pinterest'); ?>"
                                name="<?php echo $this->get_field_name('pinterest'); ?>" type="text"
                                value="<?php echo $pinterest; ?>"/></label></p>
            </div>

            <!-- flickr -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e('Flickr:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('flickr'); ?>"
                                name="<?php echo $this->get_field_name('flickr'); ?>" type="text"
                                value="<?php echo $flickr; ?>"/></label></p>
            </div>


            <!-- YouTube -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('YouTube:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('youtube'); ?>"
                                name="<?php echo $this->get_field_name('youtube'); ?>" type="text"
                                value="<?php echo $youtube; ?>"/></label></p>
            </div>

            <!-- Picasa -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('Picasa'); ?>"><?php _e('Picasa:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('picasa'); ?>"
                                name="<?php echo $this->get_field_name('picasa'); ?>" type="text"
                                value="<?php echo $picasa; ?>"/></label></p>
            </div>

            <!-- instagram -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('instagram'); ?>"><?php _e('Instagram:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('instagram'); ?>"
                                name="<?php echo $this->get_field_name('instagram'); ?>" type="text"
                                value="<?php echo $instagram ?>"/></label></p>
            </div>

            <!-- podcasts -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('podcasts'); ?>"><?php _e('Podcasts:'); ?> <input
                                class="widefat" id="<?php echo $this->get_field_id('podcasts'); ?>"
                                name="<?php echo $this->get_field_name('podcasts'); ?>" type="text"
                                value="<?php echo $podcasts ?>"/></label></p>
            </div>

            <!-- RSS -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('rss'); ?>"><?php _e('RSS:'); ?></p>
                <p><strong>Note:</strong> Be sure this is a valid RSS feed URL. For WordPress sites, you can obtain the
                    RSS feed url be appending "/feed" to the end of the site's URL. For example:
                    http://fyi.uwex.edu/your-site-name/feed</p>
                <input class="widefat" id="<?php echo $this->get_field_id('rss'); ?>"
                       name="<?php echo $this->get_field_name('rss'); ?>" type="text"
                       value="<?php echo $rss; ?>"/></label></p>
            </div>

            <!-- Email -->
            <div class="cets-social-admin-section-wrap">
                <p><label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email:'); ?></p>
                <p><strong>Note:</strong> This should be a valid URL. If you want to have this be an email link instead,
                    enter "mailto:" followed by your email address. <br>For example: mailto:jane.doe@ces.uwex.edu</p>
    ...
    function string_prefix_check($string, $prefix = 'http') {
        ...
        if (!$string) {
            return '';
        } //verify we were given SOME string.
...
function cets_social_media_widget_css_public() {
    ...
    ?>
    <link rel="stylesheet" href="<?php echo plugins_url('css/cets-social-media-links-widget.css', __FILE__) ?>"
          type="text/css"/>
    <?php
}
...
function cets_social_media_widget_css_admin() {
    ...
    // CSS and Javascript for HTML HEAD
    ?>
    <link rel="stylesheet" href="<?php echo plugins_url('css/cets-social-media-links-widget-admin.css', __FILE__) ?>"
          type="text/css"/>
    <?php
}
