...
Description: Allows you to hide posts from things like category archives, the home page, or search results.  (You probably don't need this plugin.)
Version: 1.4.cets
Author: Jason Lemahieu & Robert Mahfoud
Text Domain: wp_hide_post
*/

/*   Changelog
 1.2.cets
    - removed rating/feedback links
    - replace is_front_page with is_home to function on posts pages
    - adjusted some labels to be clearer
    - removed logging
*/
...
?>
    <label for="wplp_post_front" class="selectit"><input type="checkbox" id="wplp_post_front" name="wplp_post_front" value="1"<?php checked($wplp_post_front, 1); ?>/>&nbsp;<?php _e('Hide on the front page / posts page.', 'wp-hide-post'); ?></label>
    ...
    <br />
    <label for="wplp_post_search" class="selectit"><input type="checkbox" id="wplp_post_search" name="wplp_post_search" value="1"<?php checked($wplp_post_search, 1); ?>/>&nbsp;<?php _e('Hide in on-site search results.', 'wp-hide-post'); ?></label>
