...
<div class="wrap">
	...
	?>
		...
		This option is perfect for replacing a .doc or .pdf file with an updated version, or replacing a very large photograph with a smaller version of the same photograph but with the same aspect ratio (ratio between width and height).  Replacing an image with an image that has a different aspect ratio will likely cause undesired results.
		</p>
		...
		<p class="howto"><?php echo __("Note: If you check this option, the name and type of the file you are about to upload will replace the old file. All links pointing to the current file (", "enable-media-replace"); ?><?php echo $current_filename; ?><?php echo __(") will be updated to point to the new file name.", "enable-media-replace"); ?><br/>
		This option is great when you want to replace links to a file with links to new a file of another type.  For example, a resource used to be a .doc, but is now a .docx file.  This option is NOT recommended for images of any kind.</p>
