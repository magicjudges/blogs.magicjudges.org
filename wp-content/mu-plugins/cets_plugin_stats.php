...
class cets_Plugin_Stats {
    ...
    function plugin_stats_page() {
        ...
        $pm_auto_activate_status = ($pm_auto_activate[0] == '' || $pm_auto_activate[0] == 'EMPTY' ? 0 : 1);
        ...
        <div class="wrap">
            ...
            <p>
                This data is not updated as blog users update their plugins. It was last
                generated <?php if (time() - $gen_time > 60) {
                    echo(round((time() - $gen_time) / 60, 0) . " minutes");
                } else echo('less than 1 minute ') ?> ago.
            <form name="plugininfoform" action="" method="post"><input type="submit" value="Regenerate"><input
                        type="hidden" name="action" value="update"/></form>
